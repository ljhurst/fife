...
describe('paychecks-remaining', () => {
    describe('isPaychecksRemainingInputsReady', () => {
        test('should return true if inputs are ready', () => {
            const input = {
                paychecksPerYear: 26,
                nextPaycheckDate: new Date('2023-03-31T00:00:00Z'),
            };
        ...
        test('should return false if nextPaycheckDate is not provided', () => {
            const input = {
                paychecksPerYear: 26,
                nextPaycheckDate: new Date('1970-01-01T00:00:00Z'),
            };
            expect(isPaychecksRemainingInputsReady(input)).toBe(false);
        });
    });
    ...
    describe('calculatePaychecksRemaining', () => {
        test('should calculate paychecks remaining correctly', () => {
            const input = {
                paychecksPerYear: 26,
                nextPaycheckDate: new Date('2025-04-18T00:00:00Z'),
            };
            const expected = 18;
        ...
        test('should handle edge cases correctly', () => {
            const input = {
                paychecksPerYear: 26,
                nextPaycheckDate: new Date('2025-04-17T00:00:00Z'),
            };
            const expected = 19;
            expect(calculatePaychecksRemaining(input)).toBe(expected);
        });
